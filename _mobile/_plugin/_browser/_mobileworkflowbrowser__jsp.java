...
public class _mobileworkflowbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
String componentid = Util.null2String(fu.getParameter("componentid"));
      ...
      out.print((SystemEnv.getHtmlLabelName(82805,user.getLanguage())));
      ...
      out.write(_jsp_string8, 0, _jsp_string8.length);
      out.print((SystemEnv.getHtmlLabelName(82806,user.getLanguage())));
      out.write(_jsp_string9, 0, _jsp_string9.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/browser/MobileWorkflowBrowser.jsp"), 2753730978837684204L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string9 = "</font>\r\n						</td>\r\n					</tr>\r\n				".toCharArray();
    _jsp_string4 = "\",\"selectids\":\"".toCharArray();
    _jsp_string12 = "</BUTTON>&nbsp;&nbsp;\r\n			     <BUTTON type=\"button\" class=btnReset accessKey=T id=\"cancelBtn\" onclick=\"onCancel()\"><u>T</u>-".toCharArray();
