...
List list = (List)pages.get("list");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/5/select.jsp"), -8978927026604500855L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  static {
    _jsp_string36 = "&scope=".toCharArray();
    _jsp_string10 = "\r\n				<td id=\"td_".toCharArray();
    _jsp_string21 = "\r\n				<div id=\"num_".toCharArray();
    _jsp_string25 = ";height:16px;color:#FFF;font-size:10pt;\">\r\n				".toCharArray();
    ...
    _jsp_string23 = "#2876A0".toCharArray();
    _jsp_string16 = "\" style=\"width:100%;height:100%;padding-top:8px;position:relative;color:".toCharArray();
    _jsp_string42 = "&month=&year=&date=\"+d;\r\n}\r\n\r\nfunction goSelect() {\r\n	var date = $(\"#date\").val();\r\n	location = \"/mobile/plugin/5/select.jsp?module=".toCharArray();
    _jsp_string24 = "#B2B2B2".toCharArray();
    _jsp_string17 = "#FFF".toCharArray();
    _jsp_string38 = "&title=".toCharArray();
    _jsp_string12 = "selected".toCharArray();
    _jsp_string18 = "#000;".toCharArray();
    _jsp_string20 = "\">\r\n				".toCharArray();
    _jsp_string33 = "\">\r\n<input type=\"hidden\" id=\"month\" name=\"month\" value=\"".toCharArray();
    _jsp_string44 = "&month=&year=&date=\"+date;\r\n}\r\n</script>\r\n\r\n</body>\r\n</html>".toCharArray();
    _jsp_string19 = "#CCC".toCharArray();
    _jsp_string26 = "\r\n				</div>\r\n				</div>\r\n				\r\n				</td>\r\n				".toCharArray();
    _jsp_string27 = "\r\n	\r\n			</tr>\r\n		</table>\r\n	\r\n		".toCharArray();
    ...
    _jsp_string29 = "\r\n		<div style=\"width:100%;height:20px;position:relative;\">\r\n			<img alt=\"\" src=\"/mobile/plugin/5/images/icon_liststyle_wev8.png\"> ".toCharArray();
    _jsp_string39 = "&month=\"+\"&year=\"+\"&date=\"+date;\r\n}\r\n\r\nfunction goMonth(d) {\r\n	var date = $(\"#date\").val();\r\n	var year = $(\"#year\").val();\r\n	var month = $(\"#month\").val();\r\n	\r\n	month = parseInt(month)+d;\r\n	year = parseInt(year);\r\n	if(month>12){\r\n		month = month-12;\r\n		year = year+1;\r\n	}\r\n	if(month<1) {\r\n		month = 12;\r\n		year = year-1;\r\n	}\r\n	location = \"/mobile/plugin/5/select.jsp?module=".toCharArray();
    ...
    _jsp_string37 = "&detailid=".toCharArray();
    _jsp_string13 = "today".toCharArray();
    ...
    _jsp_string41 = "&month=\"+month+\"&year=\"+year+\"&date=\";\r\n}\r\n\r\nfunction goDate(d) {\r\n	location = \"/mobile/plugin/5/select.jsp?module=".toCharArray();
    _jsp_string35 = "\">\r\n\r\n<div id=\"loading\">\u6b63\u5728\u52a0\u8f7d\u6570\u636e\uff0c\u8bf7\u7a0d\u7b49...</div>\r\n<div id=\"loadingmask\" class=\"ui-widget-overlay\"></div>\r\n\r\n<script type=\"text/javascript\">\r\n$(document).ready(function() {\r\n	\r\n	$( \"#loading\" ).hide();\r\n	$( \"#loadingmask\" ).hide();\r\n	\r\n});\r\n\r\nfunction goToday() {\r\n	var date = $(\"#today\").val();\r\n	\r\n	location = \"/mobile/plugin/5/select.jsp?module=".toCharArray();
    _jsp_string30 = "\r\n		</div>\r\n	".toCharArray();
    _jsp_string14 = "\" onclick=\"javascript:goDate('".toCharArray();
    _jsp_string11 = "\" width=\"14%\" align=\"center\" class=\"schedule ".toCharArray();
    _jsp_string40 = "&month=\"+month+\"&year=\"+year+\"&date=\";\r\n}\r\n\r\nfunction goYear(d) {\r\n	var date = $(\"#date\").val();\r\n	var year = $(\"#year\").val();\r\n	var month = $(\"#month\").val();\r\n	\r\n	month = parseInt(month);\r\n	year = parseInt(year) + d;\r\n	\r\n	location = \"/mobile/plugin/5/select.jsp?module=".toCharArray();
    _jsp_string0 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string43 = "&month=&year=&date=\"+date;\r\n}\r\n\r\nfunction goList() {\r\n	var date = $(\"#date\").val();\r\n	location = \"/mobile/plugin/5/list.jsp?module=".toCharArray();
    _jsp_string22 = "\" style=\"position:absolute;bottom:-2px;right:-2px;width:30px;background:".toCharArray();
    _jsp_string1 = "\r\n\r\n".toCharArray();
    _jsp_string31 = "\r\n	</div>\r\n	</a>\r\n\r\n	<div style=\"height:40px;background:#B2C0D7 url(/mobile/plugin/5/images/bg_tabbg_wev8.png) repeat-x;\">\r\n	<table style=\"width:100%;height:40px;\">\r\n		<tr>\r\n			<td width=\"10px\"></td>\r\n			<td width=\"53px\" align=\"center\" valign=\"middle\">\r\n			<a href=\"javascript:goToday();\">\r\n			<div style=\"width:53px;height:30px;line-height:30px;background:url(/mobile/plugin/5/images/btn_tab_today_wev8.png) no-repeat;color:#000;\">\u4eca\u5929</div>\r\n			</a>\r\n			</td>\r\n			<td width=\"70%\" align=\"center\" valign=\"middle\">\r\n			<div style=\"width:138px;height:30px;\">\r\n				<a href=\"javascript:goList();\">\r\n				<div style=\"float:left;width:69px;height:30px;line-height:30px;background:url(/mobile/plugin/5/images/btn_tab_date_wev8.png) no-repeat;color:#000;\">\u65e5</div>\r\n				</a>\r\n				<a href=\"javascript:goSelect();\">\r\n				<div style=\"float:right;width:69px;height:30px;line-height:30px;background:url(/mobile/plugin/5/images/btn_tab_month_wev8.png) no-repeat;color:#000;\">\u6708</div>\r\n				</a>		\r\n			</div>\r\n			</td>\r\n			<td width=\"53px\">&nbsp;</td>\r\n			<td width=\"10px\"></td>\r\n		</tr>\r\n	</table>\r\n	</div>\r\n\r\n</div>\r\n\r\n<input type=\"hidden\" id=\"date\" name=\"date\" value=\"".toCharArray();
  }
}
