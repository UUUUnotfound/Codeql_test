...
if(!"".equals(groupId)&&groupId != null){
	...
	String html = WorkflowServiceUtil.getAddJsString(workflowid,nodeId,user,derecorderindexInt,groupIdInt,rowIndexInt,isEditsBoolean,isdisplayBoolean,tableOrderIdInt,newRowNum);
	out.println(html);
}
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/1/form/detail/rowhtml.jsp"), -1038771079604247666L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
