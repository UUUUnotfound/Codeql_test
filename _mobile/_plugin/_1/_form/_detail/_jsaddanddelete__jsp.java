...
public class _jsaddanddelete__jsp extends com.caucho.jsp.JavaPage
{
  ...
  static {
    ...
    _jsp_string7 = "&rowIndex=\"+nodenum+\"&isEdits=".toCharArray();
    _jsp_string2 = "\").value;\r\n		var newRowNum = document.getElementById(\"newRowNum".toCharArray();
    _jsp_string1 = "(obj){\r\n        var nodenum = document.getElementById(\"nodenum".toCharArray();
    _jsp_string12 = "\";\r\n      if(!confirm(str)){\r\n            return false;\r\n      }\r\n       return true;\r\n   }\r\n</script>\r\n\r\n".toCharArray();
    _jsp_string8 = "&isdisplay=".toCharArray();
    _jsp_string9 = "&tableOrderId=".toCharArray();
