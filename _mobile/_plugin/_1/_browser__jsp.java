...
//\u662f\u79d1\u76ee\u6d4f\u89c8\u6309\u94ae
if("listFnaBudgetFeeType".equals(method)){
	//\u662f\u81ea\u5b9a\u4e49\u8d39\u63a7\u6d41\u7a0b
	boolean isFnaSubmitRequest4Mobile = Util.getIntValue(request.getParameter("isFnaSubmitRequest4Mobile"), -1)==1;
	if(isFnaSubmitRequest4Mobile){
		int orgtype = Util.getIntValue(request.getParameter("orgtype"), -1);
		int orgid = Util.getIntValue(request.getParameter("orgid"), -1);
		braction.setFnaSubmitRequest4Mobile(isFnaSubmitRequest4Mobile);
...
response.getOutputStream().flush();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/1/browser.jsp"), -5674432417126457648L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
