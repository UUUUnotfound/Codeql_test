...
if("getLeaveDays".equals(action)){
	...
	String result = wfService.getLeaveDays(fromDate, fromTime, toDate, toTime, resourceId);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/1/workflowBillAction.jsp"), 8770273797739723785L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
